    ...
    <body class="accueil antialiased selection:text-white">
        ...
        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Bienvenue, {{ auth()->user()->prenom }}</h2>
            ...
            <div class="grid md:grid-cols-2-image gap-6 p-6">
                <a href="{{ route('medicaments') }}" class="overflow-hidden">
                            ...
                            <tr>
                                ...
                                @foreach ($rapports as $rapport)
                                    ...
                                    <tr class="capitalize">
                                        ...
                                        <td>{{ $rapport->motif }}</td>
                                        <td>{{ $rapport->bilan }}</td>
                                        <td>{{ $rapport->offrir->first()->medicament->nomCommercial }}</td>
                                        <td>{{ $rapport->offrir->first()->quantite }}</td>
                                        <td> <a href="/rapport-modif?id={{ $rapport->id }}"> Modifier </a> </td>
                                    </tr>
